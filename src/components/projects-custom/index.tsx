...
const Projects = ({ projects: _projects }: { projects: SanitizedExternalProject[] }) => {
  ...
  return (
    <section id="projects" className="relative overflow-hidden w-full border-t border-[rgba(255,255,255,0.02)] bg-[rgba(10,10,10,0.3)]">
      ...
      <div className="max-w-[1200px] mx-auto px-[1.5rem] md:px-[3rem] py-[2.8rem] relative z-20">
        ...
        <div className="max-w-[700px]">
          <div className="project-card reveal bg-[var(--surface)] p-[2rem] border border-[var(--border)] relative overflow-hidden transition-colors duration-250 hover:bg-[var(--surface2)] group backdrop-blur-[4px]">
